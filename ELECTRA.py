...
train_encodings = tokenizer(train_texts.tolist(), truncation=True, padding=True, max_length=91)
test_encodings = tokenizer(test_texts.tolist(), truncation=True, padding=True, max_length=91)
...
# Optimización
optimizer = AdamW(model.parameters(), lr=5.913501096965149e-05, weight_decay=0.1318627444995018)
