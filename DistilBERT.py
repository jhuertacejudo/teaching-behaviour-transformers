...
# Cargar modelo y tokenizador de DistilBERT entrenado en español
...
# Tokenización
train_encodings = tokenizer(train_texts.tolist(), truncation=True, padding=True, max_length=62)
test_encodings = tokenizer(test_texts.tolist(), truncation=True, padding=True, max_length=62)
...
optimizer = AdamW(model.parameters(), lr=5.818526511809107e-05, weight_decay=0.36268766549427633)
